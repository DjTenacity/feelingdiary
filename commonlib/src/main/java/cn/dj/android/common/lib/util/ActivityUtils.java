...
public class ActivityUtils {
    ...
    public static boolean isActivityExists(String packageName, String className) {
        ...
        return !(App.context.getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(App.context.getPackageManager()) == null ||
                App.context.getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void launchActivity(String packageName, String className, Bundle bundle) {
        App.context.startActivity(IntentUtils.getComponentIntent(packageName, className, bundle));
    }
